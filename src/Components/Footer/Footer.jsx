    ...
    return (
        <Box
            ...
            <Container
                ...
                <Text>Student Helper</Text>
                <Stack direction={'row'} spacing={6}>
                    <SocialButton label={'Github'} href={'https://github.com/shivamrajpoot7070'}>
                        <FaGithub />
                    </SocialButton>
                    <SocialButton label={'Instagram'} href={'https://instagram.com/cvm.env'} blank='_'>
                        <FaInstagram />
                    </SocialButton>
                </Stack>
            </Container>
